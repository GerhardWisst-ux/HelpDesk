...
<head>
    ...
    <style>
        ...
        .dataTables_wrapper .dataTables_filter, #TablePrioritäten_info {
            margin-left: 1.2rem !important;
        ...
        @media screen and (max-width: 767px) {
            ...
            #TablePrioritäten td:nth-child(1),
            #TablePrioritäten td:nth-child(2),
            #TablePrioritäten td:nth-child(3),
            #TablePrioritäten th:nth-child(4) {
                display: table-cell;
