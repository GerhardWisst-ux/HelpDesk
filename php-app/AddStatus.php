...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($formErrors)) {
        $stmt = $pdo->prepare("INSERT INTO status (Description) VALUES (:description)");
        $stmt->execute(['description' => $description]);
        $successMessage = "Status erfolgreich hinzugefügt!";
    ...
    <div class="wrapper">
        <header class="custom-header py-2 text-white">
            <div class="container-fluid d-flex justify-content-between align-items-center">
                <h2 class="h4 mb-0 text-center flex-grow-1">Helpdesk - Status hinzufügen</h2>
                <div class="text-end">
