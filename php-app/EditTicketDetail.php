    ...
    <form action="EditTicketDetailEntry.php" method="post">
        ...
        <div class="container-fluid">
          <div class="row align-items-center">
            ...
            <div class="col-12 text-center mb-2 mb-md-0">
              <h2 class="h4 mb-0">Helpdesk - Ticketdetail bearbeiten</h2>
            </div>
      ...
      <div class="mx-2">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-3">
            <input id="ticketdetailid" maxlength="150" class="form-control" type="text"
              value="<?= $_SESSION['TicketDetailID'] ?>" disabled>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input id="billingHours" class="form-control" type='number' step='0.01' placeholder='0.00'
              name="billingHours" value="<?= number_format($result['BillingHours'], 2, '.', ',') ?>">
