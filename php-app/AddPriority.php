...
<body>
    ...
    <div id="addPriority">
        <form action="AddPriorityEntry.php" method="post">
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 text-center mb-2 mb-md-0">
                            <h2 class="h4 mb-0">Helpdesk - Priorität hinzufügen</h2>
                        </div>
            ...
            <div class="mx-2">
                ...
                <div class="form-group row me-4">
                    ...
                    <div class="col-sm-1">
                        <input class="form-control" type="number" id="sortorder" name="sortorder" required>
                ...
                <div class="form-group row me-4">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <a href="Prioritaeten.php" title="Zurück zun den Prioritäten" class="btn btn-primary"><i
