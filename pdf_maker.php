...
$inv_det_query = "SELECT T2.PRODUCT_NAME, T2.NUMBER, T2.AMOUNT FROM INVOICE_DET T2 WHERE T2.MST_ID='" . $MST_ID . "' ";
...
<table cellpadding="5" cellspacing="0" style="width: 100%;" border="0">
    <tr style="background-color: #cccccc; padding:5px;">        
        <td style="text-align: left; width: 300px;"><b>Position</b></td>
        <td style="text-align: left; width: 250px;"><b>Stunden</b></td>
...
while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
    ...
    $html .= "
    <tr>        
        <td style='vertical-align: top; width: 350px;'>{$row['PRODUCT_NAME']}</td>
        <td style='vertical-align: top; width: 125px; text-align:right;'>" . number_format($row['NUMBER'], 2, '.', ',') . "</td>
        <td style='vertical-align: top; width: 75px; text-align:right;'>" . number_format($row['AMOUNT'], 2, '.', ',') . "</td>        
		
    </tr>";
}

$html .= "<tr>
	<td style='vertical-align: top; width: 350px;'>SUMME</td>
	<td style='vertical-align: top; width: 125px; text-align:right;'></td>
    <td style='vertical-align: top; width: 75px; text-align:right;'>" . number_format($gesamtpreis, 2, '.', ',') . "</td>
</tr>
<tr>
	<td style='vertical-align: top; width: 350px;'>MWST</td>
	<td style='vertical-align: top; width: 125px; text-align:right;'></td>
    <td style='vertical-align: top; width: 75px; text-align:right;'>" . number_format($gesamtpreis * 0.19, 2, '.', ',') . "</td>
</tr>
<tr>
	<td style='vertical-align: top; width: 350px;'><b>RECHNUNGSBETRAG</b></td>
	<td style='vertical-align: top; width: 125px; text-align:right;'></td>
    <td style='vertical-align: top; width: 75px; text-align:right;'><b>" . number_format($gesamtpreis * 1.19, 2, '.', ',') . "</b></td>
</tr>
